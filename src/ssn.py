...
def create_model():
    ...
    x1 = Conv2D(32, kernel_size=(3, 3), activation='relu')(input_s1)
    x1 = Conv2D(64, kernel_size=(3, 3), activation='relu')(x1)
    x1 = MaxPooling2D(pool_size=(2, 2))(x1)
    x1 = Dropout(0.2)(x1)
    x2 = Conv2D(32, kernel_size=(3, 3), activation='relu')(input_s2)
...
if __name__ == "__main__":
    ...
    if FLAGS.model_path:
        ...
        # define net
        model = create_model()
        train_model_2(model, FLAGS)
    validate_model_2(model, FLAGS)
    predict_result_2(model, FLAGS)
